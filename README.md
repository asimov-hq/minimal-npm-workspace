...
## example usage
```shellsession
wizard23@battleship minimal-npm-workspace % ./scripts/copy-minimal-sample.sh ../my-awesome-new-project
Copied files:
  - .gitignore
  - tsconfig.base.json
  - package.json
...
wizard23@battleship minimal-npm-workspace % cd ../my-awesome-new-project
